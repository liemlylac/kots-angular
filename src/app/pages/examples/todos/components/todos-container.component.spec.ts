...
import { selectRemoveDoneTodosDisabled, selectTodos, selectTodosFilter } from '../todos.selectors';
...
describe('TodosComponent', () => {
  ...
  const getTodoInput = () => fixture.debugElement.query(By.css('kots-big-input input'));
